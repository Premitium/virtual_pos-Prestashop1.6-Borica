<?php
class Virtual_posDisplayPaymentController
{
	...
	{
		$api_url = Configuration::get('VIRTUAL_POS_API_URL');
		$api_credentials_id = Configuration::get('VIRTUAL_POS_API_CRED_ID');
		$api_credentials_salt = Configuration::get('VIRTUAL_POS_API_CRED_SALT');
		...
		$validation_url = $this->context->link->getModuleLink('virtual_pos', 'validationapi');
		...
		$this->context->controller->addCSS($this->_path.'views/css/virtual_pos_front.css', 'all');
