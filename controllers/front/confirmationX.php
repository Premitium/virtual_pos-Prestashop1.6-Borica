...
class Virtual_posConfirmationModuleFrontController extends ModuleFrontController
{
    ...
    public function postProcess()
    {
        ...
        $responce_code = $_GET["responce"];

        if ($responce_code) {
          echo '<pre>', var_dump($responce_code), '</pre>';
          die('responce defined');
        }else {
          die('reps not set');
        }
        ...
        // $paypal->validateOrder($id_cart, getOrderStatus('payment_error'),
